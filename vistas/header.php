...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="escritorio.php" class="logo">
      ...
      <span class="logo-lg"><b>Worker</b> Control</span>
    </a>
...
-->
      <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="departamento.php"><i class="fa fa-circle-o"></i> Tipo de Empleado</a></li>
          </ul>
      </li>

      <li class="treeview">
          <a href="#">
            <i class="fa fa-folder"></i> <span>Tipo Empleado</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="departamento.php"><i class="fa fa-circle-o"></i> Tipo Empleado</a></li>            
          </ul>
      </li>
